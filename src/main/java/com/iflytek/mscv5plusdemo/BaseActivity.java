...
import com.iflytek.speech.util.ErrorInfo;
import com.iflytek.speech.util.TTSController;
...
//        mAMapNavi.stopNavi();
    ...
    public void onArriveDestination() {
        //到达目的地
        ((SpeechApp) getApplication()).mTts.startSpeaking("您已到达目的地", new SynthesizerListener() {
            @Override
